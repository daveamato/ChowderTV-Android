...
public class CategoryItemActivity extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (JsonUtils.isNetworkAvailable(CategoryItemActivity.this)) {
			...
			alert.showAlertDialog(CategoryItemActivity.this, getString(R.string.conn_msg4),
		...
		lsv_latest.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intcat=new Intent(CategoryItemActivity.this,SingleChannelActivity.class);
	...
	public void setAdapterToListview() {
		objAdapterHome = new HomeGridAdapter(CategoryItemActivity.this, R.layout.list_row,
				arrayOfHome);
