...
public class Constant implements Serializable{
	...
	public static String SERVER_URL = "http://www.viaviweb.in/envato/live_tv";
	...
	//latest
	public static final String LATEST_URL = SERVER_URL + "/api.php?latest=15";
	...
	//report channel
	public static final String REPORT_CHANNEL_URL = SERVER_URL + "/api.php?review=";
